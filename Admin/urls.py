...
urlpatterns = [
    ...
    path('programs/datetype/add/', views.AdminDateTypeAdd.as_view(), name='datetype_add'),
    ...
    path('programs/streamtype/add/', views.AdminStreamTypeAdd.as_view(), name='streamtype_add'),
    ...
    path('programs/videocontent/add/', views.AdminVideoContentAdd.as_view(), name='videocontent_add'),
    ...
    path('programs/videostat/add/', views.AdminVideoStatAdd.as_view(), name='videostat_add'),
    ...
    path('programs/voicecontent/add/', views.AdminVoiceContentAdd.as_view(), name='voicecontent_add'),
    ...
    path('programs/voicestat/add/', views.AdminVoiceStatAdd.as_view(), name='voicestat_add'),
